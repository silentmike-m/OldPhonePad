...
public interface IPhonePadService
{
    ...
    /// </summary>
    /// <param name="input">Input sequence to be decoded.</param>
    /// <param name="keyMapStrategy">Strategy that should be used to decoded input.</param>
    /// <param name="skipInvalidChars">Skip invalid character or throw exception</param>
    /// <returns>The decoded text string. Returns empty string if input is null or empty.</returns>
